package com.impt.bibliotheque.securityconfig;
...
//auteur
				...
				.antMatchers("/remove-author/**").permitAll()
//Livre
				...
				.antMatchers("/remove-book/**").permitAll()
...
//Category
				...
				.antMatchers("/remove-category/**").permitAll()
...
//Publisher
				...
				.antMatchers("/remove-publisher/**").permitAll()
